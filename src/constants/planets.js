...
export const PLANETS_INFO = [
{
    ...
    structurelink: 'https://en.wikipedia.org/wiki/Mercury_(planet)#Internal_structure',
    // structurelink: 'https://en.wikipedia.org/wiki/Mercury_(planet)#Internal_structure',
    ...
    geologylink: 'https://en.wikipedia.org/wiki/Mercury_(planet)#Surface_geology',
    rotation: '58.6 Days',
...
},
{
    ...
    structurelink: 'https://en.wikipedia.org/wiki/Venus#Internal_structure',
    geology:
        'Much of the Venusian surface appears to have been shaped by volcanic activity. Venus has several times as many volcanoes as Earth, and it has 167 large volcanoes that are over 100 km (60 mi) across. The only volcanic complex of this size on Earth is the Big Island of Hawaii.',
    geologylink: 'https://en.wikipedia.org/wiki/Venus#Surface_geology',
    rotation: '243 Days',
...
},
{
    ...
    structurelink: 'https://en.wikipedia.org/wiki/Earth#Internal_structure',
    geology:
...
},
{
    ...
    overviewlink: 'https://overviewlinkipedia.org/wiki/Mars',
    structure:
        'Like Earth, Mars has differentiated into a dense metallic core overlaid by less dense materials. Scientists initially determined that the core is at least partially liquid. Current models of its interior imply a core consisting primarily of iron and nickel with about 16–17% sulfur.',
    structurelink: 'https://structurelinkipedia.org/wiki/Mars#Internal_structure',
    geology:
        'Mars is a terrestrial planet whose surface consists of minerals containing silicon and oxygen, metals, and other elements that typically make up rock. The surface is primarily composed of tholeiitic basalt, although parts are more silica-rich than typical basalt.',
    geologylink: 'https://geologylinkipedia.org/wiki/Mars#Surface_geology',
    rotation: '1.03 Days',
...
},
{
    ...
    structurelink:'https://en.wikipedia.org/wiki/Jupiter#Internal_structure',
    ...
    geologylink:'https://en.wikipedia.org/wiki/Jupiter#Great_Red_Spot_a,nd_other_vortices',
    rotation: '9.93 Hours',
...
},
{
    ...
    structurelink: 'https://en.wikipedia.org/wiki/Saturn#Internal_structure',
    ...
    geologylink: 'https://en.wikipedia.org/wiki/Saturn#Atmosphere',
    rotation: '10.8 Hours',
...
},
{
    ...
    structurelink: 'https://en.wikipedia.org/wiki/Uranus#Internal_structure',
    ...
    geologylink:'https://en.wikipedia.org/wiki/Uranus#Atmosphere',
    rotation: '17.2 Hours',
    revolution: '84 Years',
    radius: '25,362 KM',
    temperature: '-195°c',
...
},
{
    ...
    overviewlink:'https://en.wikipedia.org/wiki/Neptune',
    ...
    structurelink:'https://en.wikipedia.org/wiki/Neptune#Internal_structure',
    ...
    geologylink:'https://en.wikipedia.org/wiki/Neptune#Atmosphere',
